...
void Java_com_aqnote_app_camera_AsciiConverter_getAsciiValuesBWNative(JNIEnv* env, jobject thiz,
...
void Java_com_aqnote_app_camera_AsciiConverter_getAsciiValuesWithColorNative(JNIEnv* env, jobject thiz,
        jbyteArray jdata, jint imageWidth, jint imageHeight, 
 ...
 */
void Java_com_aqnote_app_camera_AsciiRenderer_fillPixelsInRowNative(
