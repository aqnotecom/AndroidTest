package com.aqnote.module.store.contentprovider;
...
import com.aqnote.module.store.R;
...
public class MultiprocessPreferences extends ContentProvider {
	...
	private static void init(Context context){
		PREFFERENCE_AUTHORITY = context.getString(R.string.module_store_multiprocess_preferences);
